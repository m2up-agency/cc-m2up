...
**Como instalar:** Buscar repo publico no GitHub
...
**Como instalar:** `git clone https://github.com/m2up-agency/ga4-m2up ~/.claude/skills/ga4-m2up`

### ads-m2up (fluxo perfeito)
**O que faz:** Diagnostico, relatorio, auditoria e estrategia para Meta Ads e Google Ads. Usa benchmarks brasileiros, Quality Gates e Health Score. Orquestra `meta-ads-m2up`, `google-ads-m2up` e `ga4-m2up`.
**Bom pra:** Diagnostico de conta, relatorio de performance, auditoria de trafego, identificar problemas de campanha
**Como instalar:** Disponivel no curso — baixar o .zip e extrair em `~/.claude/skills/ads-m2up/`
...
**Como instalar:** `git clone https://github.com/m2up-agency/meta-ads-m2up ~/.claude/skills/meta-ads-m2up`
...
**Como instalar:** `git clone https://github.com/m2up-agency/google-ads-m2up ~/.claude/skills/google-ads-m2up`
