...
> Pra Meta Ads, Google Ads e GA4 use as skills m2up, que ja embrulham as APIs em comandos prontos com as melhores praticas (benchmarks BR, Quality Gates, Health Score). Listadas tambem em `templates/skills/catalogo.md`.
...
**Recomendacao:** Use a skill `/ga4-m2up` (ja vem com 13 subcomandos prontos: realtime, landing pages, conversoes, etc). Repo: github.com/m2up-agency/ga4-m2up
...
**Recomendacao:** Use a skill `/meta-ads-m2up` (43 subcomandos cobrindo CRUD completo + targeting). Orquestrada por `/ads-m2up` quando precisar de diagnostico/relatorio. Repo: github.com/m2up-agency/meta-ads-m2up
...
**Recomendacao:** Use a skill `/google-ads-m2up` (30 subcomandos: GAQL + CRUD + Quality Score + Keyword Planner). Orquestrada por `/ads-m2up` quando precisar de diagnostico/relatorio. Repo: github.com/m2up-agency/google-ads-m2up
